...
C Dwarven Outfitters |QID|179|
T Dwarven Outfitters |QID|179|

A A New Threat |QID|170|
B sell trash and buy 1 stack of Light Shot
...
C The Boar Hunter |N|should hit level 4. If not, grind| |QID|183|

R camp to the southeast
T Coldridge Valley Mail Delivery (Part 2) |QID|234|
A The Troll Cave |QID|182|
A Scalding Mornbrew Delivery |QID|3364|
K kill trolls until ~1 minute left on the delivery quest
D spirit rez and run to Anvilmar
...
R back out the cave, dragging a mob with you get you to low health
T The Stolen Journal |N|choose the shield| |QID|218|
A Senir's Observations (Part 1) |QID|282|

R northwest to the camp
...
C A Favor for Evershine |N|A bit southwest of Brewnall Village (28,48.5)| |QID|319|
...
D spirit rez at Coldridge Valley
H to Kharanos
...
R west of the quarry
D spirit rez in Kharanos

A Taming the Beast (part 1) |QID|6064| |C|Hunter|
C Taming the Beast (part 1) |QID|6064| |C|Hunter|
T Taming the Beast (part 1) |QID|6064| |C|Hunter|

A Taming the Beast (part 2) |QID|6084| |C|Hunter|
C Taming the Beast (part 2) |QID|6084| |C|Hunter|
T Taming the Beast (part 2) |QID|6084| |C|Hunter|

A Taming the Beast (part 3) |QID|6085| |C|Hunter|
C Taming the Beast (part 3) |QID|6085| |C|Hunter|
T Taming the Beast (part 3) |QID|6085| |C|Hunter|

A Training the Beast |QID|6086| |C|Hunter|
N tame a cat
R Ironforge

T Training the Beast |QID|6086| |C|Hunter|
B train skills
N feed pet
T The Reports |QID|291|

R take shortcut to Menethil
